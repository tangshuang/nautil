(function () {
  ...
  ********************************************** */
  ...
  var linkCompiler = function (ref) {
    ...
    var isSidebar = ref.isSidebar; if ( isSidebar === void 0 ) isSidebar = false;

    var link = function (href, title, text) {
      ...
      if (
        ...
        var sidebarAbsolutePath = compiler.config.sidebarAbsolutePath;
        var basePath =
  ...
  Compiler.prototype.compileSidebar = function compileSidebar (text) {
