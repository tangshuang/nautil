    ...
    return class extends Component {
      onInit() {
        ...
        if (process.env.RUNTIME_ENV === 'ssr') {
          ...
          Component._pollutedComponents = Component._pollutedComponents || []
          Component._pollutedComponents.push({ component, defaultProps })
          // polluted components will be recovered by ssr createHttp function after renderToString
        }
        else {
