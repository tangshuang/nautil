import { interpolate, getObjectHash, mergeObjects, isObject, isArray, isObjectsAbsolutelyEqual, isFunction } from './utils.js'
...
export class Depository {
  ...
  constructor(options = {}) {
    this.options = mergeObjects(Depository.defaultOptions, options)
