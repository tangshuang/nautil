...
import { assign, parse, isBoolean } from '../core/utils.js'
...
Object.assign(ScrollSection.prototype, {
  render() {
    const {
      onHint$,
      onHintEnter$,
    ...
    const stylesheet = {
      ...style,
      overflowX: isBoolean(horizontal) ? horizontal ? 'scroll' : 'hidden' : 'auto',
      overflowY: isBoolean(vertical) ? vertical ? 'scroll' : 'hidden' : 'auto',
    }
