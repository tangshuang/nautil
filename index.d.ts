...
import type { Component as ReactComponent, ReactChildren, ErrorInfo, ReactElement, ComponentType, ComponentClass, FunctionComponent, ReactNode, ReactChild } from 'react';
...
export declare function createRouteComponent(path: string, creator: (callbackers: { isRouteActive: boolean; inactiveRoute: () => void }) => (props: any) => NautilElement)
