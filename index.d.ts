...
import { Component as ReactComponent, ReactChildren, ErrorInfo, ReactElement, ComponentType } from 'react';
...
type ComponentGenerator = (C: NautilComponent) => NautilComponent;
...
export declare function pipe(wrappers: ((C: JSXComponent) => ComponentGenerator)[]): ComponentGenerator;
